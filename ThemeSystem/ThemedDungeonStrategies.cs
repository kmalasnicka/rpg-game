...
public sealed class LibraryDungeonStrategy : IDungeonStrategy{
    ...
    public void Build(DungeonBuilder builder){
        builder
            ...
            .AddStep(new AddWeaponsStep(5, _theme.CreateWeaponFactory()))
            .AddStep(new AddArtifactStep(_theme.CreateArtifact()))
            .AddStep(new AddEnemiesStep(6, _theme.CreateEnemyFactory()));
    }
}
...
public sealed class ForgeDungeonStrategy : IDungeonStrategy{
    ...
    public void Build(DungeonBuilder builder){
        builder
            ...
            .AddStep(new AddWeaponsStep(8, _theme.CreateWeaponFactory()))
            .AddStep(new AddArtifactStep(_theme.CreateArtifact()))
            .AddStep(new AddEnemiesStep(7, _theme.CreateEnemyFactory()));
    }
}
